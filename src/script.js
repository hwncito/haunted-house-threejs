...
// change some values for shadows in the graves
...
// change some values for the shadows of the ghosts
...
// loop through graves to add shadow
const { children: gravesArray } = graves
